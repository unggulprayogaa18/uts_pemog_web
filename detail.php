...
<body>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive overflow-auto">
              <table class="table table-bordered text-center">
                ...
                <tbody id="tabeluntukdetail" style="  font-family: 'Space Mono', monospace; ">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>RS Prayoga<span>.</span></h3>
            <p>
              puput unggul prayoga<br>
              semarang <br>
              indonesia <br><br>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>21552011087</span></strong>. puput unggul prayoga TIF 221PB
      </div>
      <div class="credits">
        Designed by <a href="">puput unggul prayoga</a>
      </div>
    </div>
  </footer><!-- End Footer -->
